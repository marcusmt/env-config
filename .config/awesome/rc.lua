...
globalkeys = gears.table.join(awful.key({ modkey }, "Left", function()
    ...
    awful.key({ modkey }, "r", function()
        ...
        awful.spawn.easy_async_with_shell("pactl get-sink-volume @DEFAULT_SINK@ | grep -Po '[0-9]{1,3}(?=%)' | head -1",
            function(stdout)
...
clientkeys = gears.table.join(awful.key({ modkey }, "x", function(c)
    c:move_to_screen()
end, {
